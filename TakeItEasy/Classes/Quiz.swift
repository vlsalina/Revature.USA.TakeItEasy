...
class Quiz {
    ...
    static func FetchQuizzes() -> [Quiz] {
        return [
            // Quiz
            Quiz(name: "Swift", image: UIImage(named: "1")!, details: Details(questions: [
                ...
                ], correctAnswer: Choice(choice: "Apple"), image: UIImage(named: "1")!),
                ...
                ], correctAnswer: Choice(choice: "an initializer"), image: UIImage(named: "1")!),
                Question(question: "\"Let\" variables are...", choices: [
                    Choice(choice: "nil"),
                    Choice(choice: "changeable"),
                    Choice(choice: "formable"),
                    Choice(choice: "constant"),
                ], correctAnswer: Choice(choice: "constant"), image: UIImage(named: "1")!),
                ...
                ], correctAnswer: Choice(choice: "Object Oriented Programming"), image: UIImage(named: "1")!),
                ...
                ], correctAnswer: Choice(choice: "behaviors"), image: UIImage(named: "1")!),
            ])
            ),
            
            
            // Quiz
            Quiz(name: "XCode", image: UIImage(named: "2")!, details: Details(questions: [
                Question(question: "XCode was developed by...", choices: [
                    Choice(choice: "Amazon"),
                    Choice(choice: "Apple"),
                    Choice(choice: "Microsoft"),
                    Choice(choice: "Google"),
                ], correctAnswer: Choice(choice: "Apple"), image: UIImage(named: "2")!),
                Question(question: "XCode is an ____", choices: [
                    Choice(choice: "protocol"),
                    Choice(choice: "class"),
                    Choice(choice: "dictionary"),
                    Choice(choice: "IDE"),
                ], correctAnswer: Choice(choice: "IDE"), image: UIImage(named: "2")!),
                Question(question: "XCode is available on what platform?", choices: [
                    Choice(choice: "Linux"),
                    Choice(choice: "Windows"),
                    Choice(choice: "Mac"),
                    Choice(choice: "Nintento"),
                ], correctAnswer: Choice(choice: "Mac"), image: UIImage(named: "2")!),
                Question(question: "What is an enum?", choices: [
                    Choice(choice: "user-defined type"),
                    Choice(choice: "class"),
                    Choice(choice: "protocol"),
                    Choice(choice: "function"),
                ], correctAnswer: Choice(choice: "user-defined type"), image: UIImage(named: "2")!),
                ...
                ], correctAnswer: Choice(choice: "Model View Controller"), image: UIImage(named: "2")!),
            ])
            ),
            
            // Quiz
            Quiz(name: "Storyboard", image: UIImage(named: "3")!, details: Details(questions: [
                ...
                ], correctAnswer: Choice(choice: "UIButton"), image: UIImage(named: "3")!),
            ...
            Quiz(name: "Collections", image: UIImage(named: "4")!, details: Details(questions: [
                ...
                ], correctAnswer: Choice(choice: "unique"), image: UIImage(named: "4")!),
                ...
                ], correctAnswer: Choice(choice: "for-in"), image: UIImage(named: "4")!),
                Question(question: "Array elements must be the same ____ type", choices: [
                    Choice(choice: "class"),
                    Choice(choice: "different"),
                    Choice(choice: "protocol"),
                    Choice(choice: "same"),
                ], correctAnswer: Choice(choice: "same"), image: UIImage(named: "4")!),
                ...
                ], correctAnswer: Choice(choice: "var ra = [Int]()"), image: UIImage(named: "4")!),
            ])
            ),
